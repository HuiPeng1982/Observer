...
module.exports = {
    'www.amazon.com': {
        ...
        incomingEncoding: utf8Encoding,
        userAgent: userAgent,
        title: ['text', '#gm_product_description > div.gm_productlabel'],
        brand: ['static', 'GAP'],
        price:['text', '#id_gm_productprice > div'],
        img: ['attr', '#id_carousel_container > div > div:nth-child(1) > img', 'src']
    }
};